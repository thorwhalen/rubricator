...
| `score-cell` | 5 | One cell: score, confidence, one-line justification, evidence spans |
| `score-column` | 5 | One criterion across all alternatives — likely better than cell-at-a-time; see research |
